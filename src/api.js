...
const fetchVaultItems = async () => {
  const response = await axios.get(`${REACT_APP_API_BASE_URL}/items`);
...
const fetchVaultItem = async (id) => {
  const response = await axios.get(`${REACT_APP_API_BASE_URL}/items/${id}`);
  return response.data;
};
...
const addVaultItem = async (item) => {
  const response = await axios.post(`${REACT_APP_API_BASE_URL}/items`, item);
  return response.data;
};
...
const deleteVaultItem = async (id) => {
  const response = await axios.delete(`${REACT_APP_API_BASE_URL}/items/${id}`);
  return response.data;
};
